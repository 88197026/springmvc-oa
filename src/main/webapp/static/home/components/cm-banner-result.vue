    ...
    <modal :show.sync="showEditModal" title="微编辑"  large width="1200px" >
        <div slot="modal-body" class="modal-body c-t">
            ...
            <div class="edit-content-warp">
               <edit-content  v-ref:edit  :apiurl="api" :showleftbox = "showEditRL" :isautoinit = "showEditRL" :istextchoosed = "showEditRL" :allresize = "showEditRL" :whres = "editWhres"  :showrightbox = "showEditRL" ></edit-content> 
            </div>
        </div>
